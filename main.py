...
actual1 = Ut.reveal_actual(price_series1_whole, forecasted_period['start'], forecasted_period['end'])
actual2 = Ut.reveal_actual(price_series2_whole, forecasted_period['start'], forecasted_period['end'])
...
forecasted = Ut.reverse_differencing(forecasted, price_series_whole, ticker1, ticker2)
